...
$query = mysql_query("SELECT pj.id_pembelian, pj.keterangan, id_penjualan, nama_merk, jenis_motor, nopol, pembeli, tgl_penjualan, harga_pembelian, harga_penjualan
                                        FROM penjualan pj 
					...
					JOIN merk m ON m.id_merk = jm.id_merk
								WHERE id_penjualan = '$_GET[id]'")or die(mysql_error());
