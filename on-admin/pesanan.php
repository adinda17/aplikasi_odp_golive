...
<div class="content-wrapper">
        ...
        <h1> Data Pesanan </h1>
            ...
            <li class="active"><a href="?pg=penjualan&act=view">Pesanan</a></li>
             </ol>
        </section>
              ...
              <div class="box box-info">
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Roti</label> <br>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" id="itemterjual" name="bayaritem" placeholder="Jumlah Pembayaran" required data-fv-notempty-message="Tidak boleh kosong">
                    </div>
