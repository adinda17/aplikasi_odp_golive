...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="assets/img/ikon.png"
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/ikon.png" > 
          <span style="font-size:25px">DATA ODP</span>
        </a>
