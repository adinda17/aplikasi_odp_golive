...
<div class="content-wrapper">
        ...
        <h1> Data Pembayaran </h1>
            ...
            <li class="active"><a href="?pg=penjualan&act=view">Data Pembayaran</a></li>
             </ol>
        </section>
...
<section class="content">
    ...
    <div class="box-header">
              ...
              <form role="form" action="cetak_nota.php" method="POST" target="_blank">
              <div class="box-body">
                  <div class="form-group">
                  <button type="submit" class="btn btn-danger">
                  <i class="fa fa-file-pdf-o">Cetak Nota</i>  
                  </button>
                  </div>
                  <div class="form-group">
                  <input type="hidden" class="form-control" id="date" name="tglpenjualan" placeholder="Nama Konsumen" value= "<?php echo $_POST['tglpenjualanaw']?>">
